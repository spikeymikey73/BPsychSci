...
:::
:::
## Week 8: Motor Development {.well .tabset .tabset-fade .tabset-pills}
...
::: {.alert .alert-info}
<h4><i class="fa-solid fa-circle-info"></i> Sex Differences in Motor Development</h4>
...
<h4><i class="fa-solid fa-circle-info"></i> Cultural Differences in Motor Development</h4>
...
<h4><i class="fa-solid fa-circle-info"></i> Individual Differences</h4>
...
<h4><i class="fa-solid fa-circle-info"></i> Children with Disabilities</h4>
...
<h4><i class="fa-solid fa-circle-info"></i> DCD</h4>
...
## Week 9: Neurodiversity {.well .tabset .tabset-fade .tabset-pills}

::: {.alert .alert-danger}
<h4><i class="fa-solid fa-circle-info"></i> A Note on Language</h4>
...
::: {.alert .alert-info}
<h4><i class="fa-solid fa-circle-info"></i> DSM-5-TR Diagnostic Criteria</h4>
...
2. Deficits in non-verbal communication behaviours used for social interaction, which ranges from:
...
3. Deficits in developing, maintaining and understanding relationships, which ranges from:
...
::: {.alert .alert-info}
<h4><i class="fa-solid fa-circle-info"></i> Prevalence</h4>
...
::: {.alert .alert-info}
<h4><i class="fa-solid fa-circle-info"></i> Heterogeneity and 'Spiky' Profile</h4>
...
::: {.alert .alert-info}
<h4><i class="fa-solid fa-circle-info"></i> Aetiology of Autism</h4>
...
- **Environmental Factors:**
  ...
  - Various maternal and pregnancy related factors have been implicated in it's development, including:
...
<table>
  <thead>
    <tr>
      <th>Predominantly Inattentive</th>
      <th>Predominantly Hyperactive</th>
      <th>Combined Type</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>
        <ul>
          <li>Individuals can demonstrate differences in their ability to concentrate and maintain focus over time and across settings.</li>
          <li>Some children and adolescents may need more time to understand concepts, plan, and initiate tasks that require a large amount of cognitive effort or require a series of several steps.</li>
          <li>They may also find managing their time and organisation difficult.</li>
          <li>Many therefore benefit from support managing their belongings and personal activities.</li>
          <li>This is the most common subtype of ADHD, and more frequently observed among females.</li>
        </ul>
      </td>
      <td>
        <ul>
          <li>Individuals can have higher levels of energy, display increased levels of excitement, and respond to factors in their environment more rapidly than same-aged peers.</li>
          <li>Hyperactivity also includes increased bodily movements, such as frequent fidgeting and an increased desire to move one's body irrespective of the social context.</li>
          <li>Increased energy can also be seen in speech, where individuals can speak more frequently or quickly during social interactions.</li>
          <li>Some children and adolescents can also exhibit reduced tolerance to boredom and more difficulty inhibiting their impulses.</li>
          <li>Some can also make decisions or engage in behaviours more spontaneously than children and adolescents without ADHD.</li>
        </ul>    
      </td>
      <td>
        <ul>
          <li>This involves a combination of characteristics and experiences of both inattention and hyperactivity.</li>
          </li>This subtype is more frequently identified in males.</li>
        </ul>
      </td>
    </tr>
  </tbody>
...
a. Attention to Detail: Often fails to give close attention to details or makes careless mistakes in schoolwork, at work, or during other activities (e.g., overlooks or misses details, work is inaccurate).
b. Sustained Attention: Often has difficulty sustaining attention in tasks or play activities (e.g., has difficulty remaining focused during lectures, conversations, or lengthy reading).
c. Attention when Spoken To: Often does not seem to listen when spoken to directly (e.g., mind seems elsewhere, even in the absence of any obvious distraction).
d. Following Instructions: Often does not follow through on instructions and fails to finish schoolwork, chores, or duties in the workplace (e.g., starts tasks but quickly loses focus and is easily sidetracked).
e. Organisation: Often has difficulty organizing tasks and activities (e.g., difficulty managing sequential tasks; difficulty keeping materials and belongings in order; messy, disorganized work; has poor time management; fails to meet deadlines).
f. Avoidance of Cognitively Demanding Tasks: Often avoids, dislikes, or is reluctant to engage in tasks that require sustained mental effort (e.g., schoolwork or homework; for older adolescents and adults, preparing reports, completing forms, reviewing lengthy papers).
g. Misplacing Items: Often loses things necessary for tasks or activities (e.g., school materials, pencils, books, tools, wallets, keys, paperwork, eyeglasses, mobile telephones).
h. Distractibility: Is often easily distracted by extraneous stimuli (for older adolescents and adults, may include unrelated thoughts).
i. Daily Activities: Is often forgetful in daily activities (e.g., doing chores, running errands; for older adolescents and adults, returning calls, paying bills, keeping appointments).
...
a. Fidgeting Behaviour: Often fidgets with or taps hands or feet or squirms in seat.
b. Leaving Seat when Seating is Expected: Often leaves seat in situations when remaining seated is expected (e.g., leaves his or her place in the classroom, in the office or other workplace, or in other situations that require remaining in place).
c. Movement when Socially Not Required: Often runs about or climbs in situations where it is inappropriate. (Note: In adolescents or adults, may be limited to feeling restless.)
d. Quiet Play: Often unable to play or engage in leisure activities quietly.
e. Excessive Activity: Is often “on the go,” acting as if “driven by a motor” (e.g., is unable to be or uncomfortable being still for extended time, as in restaurants, meetings; may be experienced by others as being restless or difficult to keep up with).
f. Increased Speech: Often talks excessively.
g. Reciprocal Conversations: Often blurts out an answer before a question has been completed (e.g., completes people’s sentences; cannot wait for turn in conversation).
h. Turn Taking: Often has difficulty waiting his or her turn (e.g., while waiting in line).
i. Interruption or Intrusion: Often interrupts or intrudes on others (e.g., butts into conversations, games, or activities; may start using other people’s things without asking or receiving permission; for adolescents and adults, may intrude into or take over what others are doing).
...
<h4><i class="fa-solid fa-circle-info"></i> Aetiology of ADHD</h4>
...
- In this context, genetic variations increase risk of a developing infant being exposed to the environmental factors associated with increased vulnerability for ADHD.
...
- Despite this, the most commonly cited environmental risk factors include:
  - **Prenatal Maternal Conditions or Maternal risk Factors:** Maternal stress during pregnancy; Pre-pregnancy obesity
  - **Exposure to Teratogens in Utero:** Maternal smoking in pregnancy; Maternal alcohol use in pregnancy; Illicit substance use during pregnancy; Exposure to environmental toxins such as lead and pollutants   
...
##### Apply knowledge of the core areas of child and adolescent development (cognitive, social, identity etc.), to characterise neurodiversity/diversity in development



### LO4

##### Demonstrate knowledge of the underlying principles of neurodiversity and strengths-based perspectives when conceptualising autism and ADHD 

### LO5

##### Apply knowledge of neuro-affirming practice to understand contemporary approaches to the assessment and support provision of autism and ADHD 

## Week 10: Gender & Sexuality {.well .tabset .tabset-fade .tabset-pills}